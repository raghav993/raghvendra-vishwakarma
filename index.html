...
<head>
    ...
    <title>Developer Raghvendra</title>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-2 col-md-6 col-6">
                                <div class="navbar-header">
                                    <a class="navbar-brand site-logo" href="index"><img src="assets/images/logo.png"
                                            alt="">Er.Raghav</a>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-2 col-md-2 col-2">
                                <div class="header-right">
                                    <div class="header-btn">
                                        <a class="theme-btn" download="My Cv" href="assets/images/cv.pdf"
                                            title="ImageName">
                                            <img class="hide-img" alt="ImageName" src="assets/images/cv.pdf">
                                            Resume
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-12">
                        <div class="wpo-static-hero-inner">
                            <div data-swiper-parallax="300" class="slide-title">
                                <h2><span>Hello,</span> I am Raghvendra.</h2>
                            </div>
                            <div data-swiper-parallax="300" class="slide-sub-title">
                                <h5>Software Designer</h5>
                            </div>
                            <div data-swiper-parallax="400" class="slide-text">
                             <p>I craft software solutions that solve problems and enhance user experience, creating intuitive digital products with impactful results.</p>
                            <div class="clearfix"></div>
                            <div class="slide-btn mb-5"><a class="theme-btn" href="#about">Hire Me</a></div>
                        </div>
    ...
    <div class="static-hero-right">
        <div class="static-hero-img">
            <div class="static-hero-img-inner">
                ...
                <div class="icon-1 floating-item"><img
                        src="https://www.logo.wine/a/logo/React_(web_framework)/React_(web_framework)-Logo.wine.svg"
                        alt=""></div>
                <div class="icon-2 floating-item"><img
                        src="https://download.logo.wine/logo/Laravel/Laravel-Logo.wine.png" alt=""></div>
                <div class="icon-3 floating-item"><img
                        src="https://e7.pngegg.com/pngimages/513/866/png-clipart-codeigniter-logo-code-igniter-logo-icons-logos-emojis-tech-companies.png"
                        alt=""></div>
                <div class="project floating-item">
                    ...
                    <div class="p-text">
                        <h3><span class="odometer" data-count="20">0</span>+</h3>
                ...
                <div class="wpo-about-content">
                    <div class="blog-sidebar">
                        <div class="widget category-widget">
                            <h3>About Me</h3>
                            <p>I am a dedicated full-stack developer with a passion for crafting innovative software solutions. With years of experience in delivering customized and scalable projects, I help businesses transform their ideas into reality through technology and creativity.</p><br>

                            <ul>
                                <li>Name : Raghvendra Vishwakarama</li>
                                <li>Date of birth : 12 June 2000</li>
                                <li>Address : Near LIG Square, Indore, MP, In 452011</li>
                                <li>Email : ramanvishwa121@gmail.com</li>
                                <li>Phone : +91 9993103682</li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<!-- start of wpo-skills-area -->
<div class="wpo-about-area section-padding" id="skills">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-12">
                <div class="wpo-about-content">
                    ...
                    <div class="wpo-about-funfact">
                        ...
                        <div class="grid">
                            <div class="grid-inner">
                                <h3><span class="odometer" data-count="58">00</span>%</h3>
                                <p>AWS</p>
                            </div>
                        </div>
                        <div class="grid">
...
<div class="wpo-work-area section-padding" id="experience">
    <div class="container">
        ...
        <div class="wpo-work-wrap">
            <div class="wpo-work-item">
                <ul>
                    ...
                    <li class="logo"><img src="assets/images/work/wtm-logo.png" alt=""></li>
                    <li class="position">Software Developer <span>Near To Palasia, Indore, MP, India 452011</span></li>
                    <li class="link"><a href="https://www.wtmit.com/">Go to website</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6 col-12">
                <div class="wpo-section-title">
                    <h2>Services</h2>
                    <!-- <p>We provide a wide range of professional services to help you build, grow, and enhance your digital presence with cutting-edge technology and creative solutions.</p> -->
                </div>
            </div>
        </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6 col-12">
                            <div class="wpo-service-item">
                                ...
                                <p>Offering high-performance, scalable, and secure websites tailored to your specific needs. Whether it's a simple site or a complex web application, everything is built with precision and care.</p>
                                <a href="#">Learn More</a>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="wpo-service-item">
                                ...
                                <h2>UI/UX Design</h2>
                                <p>Creating engaging and intuitive user interfaces that enhance the overall user experience. Each design is crafted to be both visually appealing and user-friendly, ensuring seamless navigation.</p>
                                <a href="#">Learn More</a>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="wpo-service-item">
                                ...
                                <p>Designing unique logos and banners that embody the essence of your brand. Every design is custom-made to give your brand a distinctive identity in the market.</p>
                                <a href="#">Learn More</a>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="wpo-service-item">
                                ...
                                <p>Building custom software solutions tailored to meet specific needs. From enterprise applications to small-scale solutions, each piece of software is designed to streamline processes and boost productivity.</p>
                                <a href="#">Learn More</a>
                            </div>
                        </div>
                    </div>
...
<div class="wpo-project-area section-padding" id="projects">
    <div class="container">
        ...
        <div class="wpo-project-wrap wpo-project-slide owl-carousel">
            <div class="wpo-project-item">
                <div class="wpo-project-img">
                    <img src="assets/images/project/veloxinfra.png" alt="">
                </div>
                <div class="wpo-project-text">
                    <h2><a href="https://veloxinfra.com/">Veloxinfra - Real Estate Project</a></h2>
                    <span>Architecture / Business</span>
                </div>
            </div>
            <div class="wpo-project-item">
                <div class="wpo-project-img">
                    <img src="assets/images/project/tolxa.png" alt="" class="img-fluid">
                </div>
                <div class="wpo-project-text">
                    <h2><a href="https://tolxa.com/">Tolxa - Rental Vecation</a></h2>
                    <span>Rental Vecation</span>
                </div>
            </div>
            <div class="wpo-project-item">
                <div class="wpo-project-img">
                    <img src="assets/images/project/bothwings.png" alt="" class="img-fluid">
                </div>
                <div class="wpo-project-text">
                    <h2><a href="https://bothwigs.in/">Bothwings - Subscription based Study Material </a></h2>
                    <span>E-Learning / Study Material</span>
                </div>
            </div>
            <div class="wpo-project-item">
                <div class="wpo-project-img">
                    <img src="assets/images/project/shrig.png" alt="" class="img-fluid">
                </div>
                <div class="wpo-project-text">
                    <h2><a href="https://shriginfotech.co.in/">ShriGinfo - Freelancing Website</a></h2>
...
<!-- <section class="wpo-testimonial-section section-padding" id="testimonial">
            <div class="container">
...
<!-- <section class="wpo-blog-section section-padding" id="news">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-5">
                <div class="wpo-section-title">
        ...
        <div class="wpo-blog-wrap wpo-blog-slide owl-carousel">
            <div class="wpo-blog-item">
                ...
                <div class="wpo-blog-text">
                    ...
                    <h2><a href="#">Have evolved over the years sometimes accident.</a></h2>
                    <a class="details" href="#">Post Details</a>
                </div>
            </div>
            <div class="wpo-blog-item">
                <div class="wpo-blog-img">
                ...
                <div class="wpo-blog-text">
                    ...
                    <h2><a href="#"> The Internet tend to repeat predefined chunks.</a></h2>
                    <a class="details" href="#">Post Details</a>
                </div>
            </div>
            <div class="wpo-blog-item">
                ...
                <div class="wpo-blog-text">
                    ...
                    <h2><a href="#">The standard chunk of used since the interested.</a></h2>
                    <a class="details" href="#">Post Details</a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col col-lg-10 offset-lg-1">
                        ...
                        <div class="col col-xl-4 col-lg-6 col-md-6 col-12">
                            <div class="office-info-item">
                                ...
                                <div class="office-info-text">
                                    <h2>Address</h2>
                                    <p>Near LIG Square, Indore, MP, IN 452011</p>
                                </div>
                            </div>
                        </div>
                        <div class="col col-xl-4 col-lg-6 col-md-6 col-12">
                            <div class="office-info-item">
                                ...
                                <div class="office-info-text">
                                    <h2>Email Us</h2>
                                    <p>ramanvishwa2121@gmail.com</p>
                                    <p>raghu99931036@gmail.com</p>
                                </div>
                            </div>
                        </div>
                        <div class="col col-xl-4 col-lg-6 col-md-6 col-12">
                ...
                <div class="wpo-contact-title">
                    ...
                    <p>If you have any inquiries or need more information, feel free to reach out. I'm here to help with any questions you might have.</p>
                </div>
            ...
            <div class="lower-footer">
                <div class="container">
                    <div class="row">
                        ...
                        <p class="copyright">@ 2025 developed By Raghvendra. All rights reserved.</p>
                    </div>
                </div>
            </div>
        </footer>
